...
namespace TestLogin.Controllers
{
    ...
    {
        public ActionResult BidOnAuction(int Id = 1, float CurrentPrice=1, float Bid=1)
        {
        ...
        public ActionResult BidOnAuction(AuctionModel model)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult CreateAuction(AuctionModel model)
        {
            if(ModelState.IsValid)
                
                {
                int recordsCreated = AuctionProcessor.CreateAuction(model.Status,
                    model.CurrentPrice,
                    model.MaxPrice
                    );
